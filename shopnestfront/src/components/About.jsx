     ...
     <AboutBanner />
      ...
      <div className="text-image-section">
        <div className="text-side">
          ...
          <p>
            Nibh ipsum consequat nisl vel. Non arcu risus quis varius quam<br />
            quisqu diam vel. Eu turpis egestas pretium aenean pharetra magna<br />
            ac placerat vestibulum. Amet dictum sit amet justo donen ante met
          </p>
      ...
      <div className="video-section">
        <div className="video-left">
          <div className="video-container">
            ...
            <div
              ...
              onClick={() =>
                window.open(
                  "https://www.youtube.com/embed/XHOmBV4js_E?feature=oembed&start&end&wmode=opaque&loop=0&controls=1&mute=0&rel=0&modestbranding=0",
                  "_blank"
                )
              }
            >
        ...
        <div className="video-right">
          ...
          <p>
            ...
            pharetra lihcerats Tellus rutrum tellus pellentesque eu tinctpell and <br />
            wretium entes wtincdur Westibulum hmet dictum sit amdone.
          </p>
      ...
      <div className="about-last">
        <div className="last-card">
          ...
          <h3>
            The most important advantage of working with an<br />
            experienced specialist is time saving, do not eliminate it!
          </h3>
        </div>
      </div>
